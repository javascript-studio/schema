 ...
 * @property {function(number): VStringSub} min
 * @property {function(number): VStringSub} max
 * @property {function(number, number): VStringSub} range
 */
/**
 * @typedef VStringProps
 * @property {'string'} type
 * @property {VStringLengthProps} length
 * @property {function(RegExp): VStringSub} regexp
 */
/**
